...
const HeroPage = () => {
    ...
    return (
        ...
        <div className='mx-24 my-8 flex flex-col gap-14 max-sm:mx-8 max-lg:mx-12'>
                ...
                >
                    ...
                    <div className='gap-6 max-lg:gap-3  flex items-center'>
                        <a href="" className="flex gap-2">
                            ...
                            <div className="md:hidden button rounded-md border border-black p-2"><svg className="w-5" fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg></div>
                        </a>
                        <a href="" className="flex gap-2">
                            <h3 className="max-sm:hidden">Telegram</h3>
                            <div className="md:hidden button rounded-md border border-black p-2"><svg className="w-5" fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"><path d="M248 8C111 8 0 119 0 256S111 504 248 504 496 393 496 256 385 8 248 8zM363 176.7c-3.7 39.2-19.9 134.4-28.1 178.3-3.5 18.6-10.3 24.8-16.9 25.4-14.4 1.3-25.3-9.5-39.3-18.7-21.8-14.3-34.2-23.2-55.3-37.2-24.5-16.1-8.6-25 5.3-39.5 3.7-3.8 67.1-61.5 68.3-66.7 .2-.7 .3-3.1-1.2-4.4s-3.6-.8-5.1-.5q-3.3 .7-104.6 69.1-14.8 10.2-26.9 9.9c-8.9-.2-25.9-5-38.6-9.1-15.5-5-27.9-7.7-26.8-16.3q.8-6.7 18.5-13.7 108.4-47.2 144.6-62.3c68.9-28.6 83.2-33.6 92.5-33.8 2.1 0 6.6 .5 9.6 2.9a10.5 10.5 0 0 1 3.5 6.7A43.8 43.8 0 0 1 363 176.7z"/></svg></div>
                        </a>
            ...
            <div className='flex justify-between max-lg:flex-col lg:items-center gap-12'>
                <div className='flex flex-col lg:w-1/2 '>
                    <motion.h1 className='distinct text-[9rem] max-lg:text-[7rem] max-sm:text-[4.5rem] text tracking-wider font-[900]'
                    ...
                    <motion.div className='flex max-sm:flex-col max-sm:gap-3 items-center rounded-md bg-[#FAEBD7] py-3 px-3 rounded-lg box border border-black justify-between mb-6'
                        initial={{ x: '30%', opacity: 0 }}
                        animate={{ x: 0, opacity: 1 }}
                        transition={{ duration: 1.5, ease: 'easeOut',delay: 1 }}
                    >
                        <h3 className="max-sm:text-center max-sm:text-[0.75rem]" >{text}</h3>
                        <button onClick={handleCopyText} className='bg-[#c27348] text-white box rounded-md px-8 max-sm:px-4 text-center py-2 button uppercase border border-black' >{buttonText}</button>
                    </motion.div>
                    ...
                    >
                        <button className='bg-[#c27348] text-white uppercase button rounded-md px-8 py-3 max-sm:px-3  border border-black '>Dexscrenner</button>
                        <button className='bg-[#c27348] text-white uppercase button rounded-md px-8 py-3 max-sm:px-3 border border-black '>Buy Now</button>
                    </motion.div>
                </div>
        ...
        <div className="kitty flex gap-10 px-6  bg-[#c27348] mb-6 py-4 ">
